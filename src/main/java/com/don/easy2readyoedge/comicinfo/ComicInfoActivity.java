...
public class ComicInfoActivity extends AppCompatActivity
  ...
  protected void onCreate(Bundle savedInstanceState) {
    ...
    if (getIntent() != null && getIntent().getExtras() != null && getIntent().getExtras().containsKey(ExtraConfigs.EX_BOOK_BEAN)) {
...
//        AppWebViewActivity.launchActivity(ComicInfoActivity.this, articleBean.getArticleUrl());
  ...
  public void findControl() {
    ...
    mAdapter = new BookActivityAdapter(new ArrayList<ArticleBean>(), getBookAdapter());
    ...
    fab.setOnClickListener(new android.view.View.OnClickListener() {
      ...
      public void onClick(android.view.View view) {
        if (!TextUtils.isEmpty(mBean.getBookName()) && !TextUtils.isEmpty(mBean.getBookUrl())) {
          mPresenter.addBook(ACache.get(ComicInfoActivity.this), view, mBean.getBookName(), mBean.getBookUrl());
        }
      }
    });
  }
  ...
  public void addDataToList(List<ArticleBean> list) {
    if (null != list && 0 < list.size()) mAdapter.addData(list);
  }
